...
export type TariffMetadataCompletenessV0 = {
...
export function computeTariffMetadataCompletenessV0(
  ...
  function creditForSource(src: unknown): number {
    ...
    if (!s) return 1; // backwards-compat: old snapshots lacked source fields
